import fs from "node:fs"; // Pacote do Node.js para manipulação de arquivos de sistema
import path from "node:path"; // Pacote do Node.js para manipulação de caminhos de arquivos
